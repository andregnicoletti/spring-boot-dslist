...
create table tb_game (score float(53), id bigint generated by default as identity, game_year varchar(255), genre varchar(255), img_url varchar(255), long_description TEXT, platforms varchar(255), short_description TEXT, title varchar(255), primary key (id));
